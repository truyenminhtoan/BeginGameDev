/*
 * @(#)MapObject.java	1.0  Aug 20, 2015 
 *
...
public abstract class MapObject {
	...
	protected boolean jumping; //NHẢY
	protected boolean falling; //RƠI

	// movement attritbutes
	...
	public void caculateCorners(double x, double y) {
		...
		int bottonTile = (int) (y + cheight / 2 - 1) / tileSize;

		int tl = tileMap.getType(topTile, leftTile);
		int tr = tileMap.getType(topTile, rightTile);
		int bl = tileMap.getType(bottonTile, leftTile);
		int br = tileMap.getType(bottonTile, rightTile);

		topLeft = tl == Tile.BLOCKED;
		topRight = tr == Tile.BLOCKED;
		bottonLeft = bl == Tile.BLOCKED;
		bottonRight = br == Tile.BLOCKED;
	}
