...
public class Player extends MapObject {
	...
	private static final int WALKING = 1;// ĐI
	private static final int JUMPING = 2;// NHẢY
	private static final int FALLING = 3;// RƠI
	...
	public void getNextPosition() {
		...
		if (left) {
			...
			// TRUONG HOP KHONG PRESS MOVE. DX GIAM = DO DE PLAYER DUNG IM
			if (dx > 0) {
				dx -= stopSpeed;
				if (dx < 0) {
					dx = 0;
		...
		// cannt acttack while moving, accept in air
